...
export default function ExecutiveDisplay() {
  return (
    <div>
        {/* section title */}
        <div className="">
            <h2 className='text-4xl ml-8 font-bold text-[#0099ff]'>Meet Our Executives</h2>
        </div>
        {/* main container */}
        <div className="w-full h-[30rem] my-8">
            {/* grid container */}
            <div className="grid w-[80%] h-full mx-auto grid-cols-3 gap-4">
                ...
                <div className="w-full flex flex-col items-center rounded-xl p-4 outline outline-2 outline-[#0099ff] h-full ">
                    {/* image container */}
                    <div className="md:h-[20rem]  rounded-full md:w-[20rem]">
                        <img className='bject-none rounded-full w-full h-full ' src={userimg} alt="" />
                    </div>
                    {/* position held */}
