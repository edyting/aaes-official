...
const Upper = () => {
    return ( 
        <div className="">
            <div className="container w-[95%] mt-2 mx-auto text-center mb-12 ">
                {/* header */}
                     ...
                     <form className='' >
                        ...
                        <div className="number flex w-full flex-col items-start mb-4">
                           ...
                           <div className="input-area flex w-full">
                              <select name="" className='bg-white py-[9.7px]  pl-2 md:w-[12%] w-[15%] rounded-l-sm border-[1.5px] border-r-[0px] mt-2' id="">
